package com.alpha.alipay.javaclass; // package jsp;
 ...
 public class Clock extends JApplet implements java.awt.event.ActionListener
  {
     Timer timer;
  ...
  //    	setSize(300,300);
    ...
    //     setResizable(false);
 	...
 	//     show();*/fra=t
     	...
     	//���������¼���������������Ĵ���
     	java.awt.event.ActionListener taskPerformer = new ActionListener()
     	{
     	...
     	new Timer(delay, (ActionListener) taskPerformer).start();
   }
